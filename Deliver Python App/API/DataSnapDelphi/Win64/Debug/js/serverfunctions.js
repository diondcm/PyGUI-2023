...
function TServerMethods1(connectionInfo)
{
   ...
   */
  this.PythonInputOutputSendUniData = function(Sender, Data) {
    this.executor.executeMethod('"PythonInputOutputSendUniData"', "POST", [Sender, Data], arguments[2], false, arguments[3], arguments[4]);
  };
  ...
  /*
   * @param text [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.AskChatGPTFromPython = function(text) {
    var returnObject = this.executor.executeMethod('AskChatGPTFromPython', "GET", [text], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.AskChatGPTFromPython_URL = function(text) {
    return this.executor.getMethodURL("AskChatGPTFromPython", "GET", [text], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["PythonInputOutputSendUniData","EchoString","ReverseString","AskChatGPTFromPython"]
};
